...
class GazeboEnv:
    def __init__(self, launchfile, environment_dim):
        ...
        # --- STAGE 2/3 SETTINGS: CLUTTERED CURRICULUM ---
        # Start TIGHT (1.0m) because obstacles make it dangerous.
        # The code will automatically expand this to 1.5, 2.0, etc. (Stage 3)
    ...
    def step(self, action):
        ...
        # --- STAGE 3 LOGIC: AUTOMATIC EXPANSION ---
        if distance < GOAL_REACHED_DIST:
            ...
            if self.success_count >= 3:
                ...
                print(f"STAGE 3 LEVEL UP! Expanding World to {self.boundary_limit} meters")
